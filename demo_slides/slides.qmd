...
- Create a script `script_NAME.R`
    - If already exists, modify slightly
...
Peer review complete, [need to make changes](https://github.com/montanolab/github-intro/issues/2)

This time, reference #2 in commit messages
...
## Branches should be managed well

Should be short-lived/temporary

```{bash eval=FALSE, echo=TRUE}
git branch -D "karthik"
```
...
1. Helping Future You
    - No idea what a script does?
    - Searchable log of project evolution ([example](https://github.com/stateofindiasbirds/soib_2023))
    - **Commits** force habit of documentation & **modularity**
2. Reproducibility as standard (journals, funders)
3. Structured time machine
